...
namespace Domotica
{
    ...
    public class MainActivity : Activity
    {
        ...
        // Controls on GUI
        Button buttonConnect, buttonChangePinState, buttonRf1, buttonRf2, buttonRf3;
        TextView textViewServerConnect, textViewTimerStateValue;
        public TextView textViewChangePinStateValue, textViewSensorValue, textViewSensorValue2, textViewDebugValue, textViewRF1, textViewRF2, textViewRF3;
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            buttonRf2 = FindViewById<Button>(Resource.Id.rf_button2);
            buttonRf3 = FindViewById<Button>(Resource.Id.rf_button3);
            textViewRF1 = FindViewById<TextView>(Resource.Id.rf_value1);
            textViewRF2 = FindViewById<TextView>(Resource.Id.rf_value2);
            textViewRF3 = FindViewById<TextView>(Resource.Id.rf_value3);
            ...
            if (buttonRf1 != null && buttonRf2 != null && buttonRf3 != null)
            {
                buttonRf1.Click += (sender, e) =>
                {
                    UpdateGUI(executeCommand("1"), textViewRF1);
                };

                buttonRf2.Click += (sender, e) =>
                {
                    UpdateGUI(executeCommand("2"), textViewRF2);
                };

                buttonRf3.Click += (sender, e) =>
                {
                    UpdateGUI(executeCommand("3"), textViewRF3);
                };
            }
        }
